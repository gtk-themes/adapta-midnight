...
glib-compile-resources --sourcedir="../gnome-shell-brila" \
                       ...
                       ./gnome-shell/gnome-shell-theme.gresource.xml
glib-compile-resources --sourcedir="../gnome-shell-midnight" \
                       --target="../gnome-shell-midnight/gnome-shell-theme.gresource" \
                       ./gnome-shell/gnome-shell-theme.gresource.xml
...
glib-compile-resources --sourcedir="../gnome-shell-brila-eta" \
                       ...
                       ./gnome-shell/gnome-shell-theme.gresource.xml
glib-compile-resources --sourcedir="../gnome-shell-midnight-eta" \
                       --target="../gnome-shell-midnight-eta/gnome-shell-theme.gresource" \
                       ./gnome-shell/gnome-shell-theme.gresource.xml
